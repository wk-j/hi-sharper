...
{
 "use strict";
 var Global,HiSharper,Client,WebSharper,UI,Var,Operators,Unchecked,System,Guid,Obj,List,T,ListModel,Arrays,Templating,Runtime,Server,TemplateInstance,Handler,HiSharper_Templates,ConcreteVar,Snap,SC$1,Collections,Dictionary,HashSet,Client$1,Seq,JavaScript,Pervasives,Doc,Abbrev,Fresh,View,DictionaryUtil,Enumerator,Object,T$1,EventTarget,Node,DomUtility,Numeric,JSModule,Docs,SC$2,Mailbox,SC$3,Storage,DocElemNode,CharacterData,SC$4,Attrs,CheckedInput,AttrModule,AttrProxy,Slice,Strings,Array,Elt,Client$2,Docs$1,RunState,NodeSet,An,HashSetUtil,ArrayStorage,Attrs$1,Dyn,String,Updates,Concurrency,Anims,AppendList,Char,DynamicAttrNode,SC$5,AsyncBody,SC$6,CT,SC$7,HashSet$1,Scheduler,CancellationTokenSource,Easing,OperationCanceledException,SC$8,Lazy,DomNodes,Queue,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$1,console,$,Date;
 Global=window;
 HiSharper=Global.HiSharper=Global.HiSharper||{};
 Client=HiSharper.Client=HiSharper.Client||{};
 ...
 HiSharper_Templates=Global.HiSharper_Templates=Global.HiSharper_Templates||{};
 ConcreteVar=UI.ConcreteVar=UI.ConcreteVar||{};
 Snap=UI.Snap=UI.Snap||{};
 SC$1=Global.StartupCode$HiSharper$Client=Global.StartupCode$HiSharper$Client||{};
 ...
 Client.Main=function()
 {
  ...
  Doc.RunById("main",(p=($1=[null],[$1,(c=Guid.NewGuid(),Global.String(c)),new T({
   $:1,
   $0:{
    $:5,
    $0:"add",
   ...
   $1:new T({
    ...
    $1:new T({
     ...
     $0:{
      $:0,
      $0:"listcontainer",
      $1:Doc.Convert(function(name)
      {
       var $2,p$2,c$1;
       return($2=[null],(p$2=Handler.CompleteHoles((c$1=Guid.NewGuid(),Global.String(c$1)),new T({
        $:1,
        $0:{
         $:1,
         $0:"name",
        ...
        $1:T.Empty
       }),[]),($2[0]=new TemplateInstance.New(p$2[1],HiSharper_Templates.listitem(p$2[0])),$2[0]))).get_Doc();
      },Client.People().v)
     },
     $1:T.Empty
    })
   })
  })]),(r=p[0],(p$1=Handler.CompleteHoles(p[1],p[2],[["name",0]]),(r[0]=new TemplateInstance.New(p$1[1],HiSharper_Templates.main(p$1[0])),r[0])))).get_Doc());
 };
 ...
 HiSharper_Templates.listitem=function(h)
 {
 ...
 HiSharper_Templates.main=function(h)
 {
  Doc.LoadLocalTemplates("index");
  return h?Doc.NamedTemplate("index",{
   $:1,
